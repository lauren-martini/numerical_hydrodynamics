...
if __name__ == "__main__":
    ...
    run_riemannsolver_basic_test(
        solver, 1.0, 0.0, 1.0, 0.125, 0.0, 0.1, 0.30313
    )
    run_riemannsolver_basic_test(
        solver, 1.0, -2.0, 0.4, 1.0, 2.0, 0.4, 0.001894
    )
    run_riemannsolver_basic_test(
        solver, 1.0, 0.0, 1000.0, 1.0, 0.0, 0.01, 460.894
    )
    run_riemannsolver_basic_test(
        solver, 1.0, 0.0, 0.01, 1.0, 0.0, 100.0, 46.095
    )
    run_riemannsolver_basic_test(
